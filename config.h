...
static const char dmenufont[]       = "Jetbrains Mono Nerd Font:size=9:antialias=true:bold";
...
/* commands */
static const char *dmenucmd[] = { "dmenu_run", "-y", "19", "-z", "230", "-l", "18", "-bw", "2", "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
static const char *termcmd[] = { "urxvt", "-tr", "-sh", "20", NULL };
...
static const char *brupcmd[] = { "xbacklight", "-inc", "4", NULL };
static const char *brdowncmd[] = { "xbacklight", "-dec", "4", NULL };
