...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,				XK_Return,	spawn,			SHCMD("~/.scripts/dmenurun") },
	{ MODKEY,							XK_p,			spawn,			SHCMD("~/.scripts/dmenupower") },
	{ MODKEY|ControlMask,			XK_s,			spawn,			SHCMD("~/.scripts/dmenuscreenshot -c") },
	{ MODKEY|ShiftMask,				XK_s,			spawn,			SHCMD("~/.scripts/dmenuscreenshot -s") },
	{ MODKEY,							XK_m,			spawn,			SHCMD("~/.scripts/dmenumans") },
	{ MODKEY,							XK_comma,	spawn,			SHCMD("~/.scripts/dmenuchars") },
	{ MODKEY,				XF86XK_AudioMute,		spawn,			{.v = (const char*[]) { "alacritty", "-e", "pulsemixer", NULL } } },
	{ MODKEY|ShiftMask,	XF86XK_AudioMute,		spawn,			{.v = (const char*[]) { "alacritty", "-e", "alsamixer", NULL } } },
};
